#To download NEW GRIB with only "Precipitation" variable. 
...
output_folder_Chlorophyll = r"D:\\Shukra_sir\\WQI_Research\\Scripts and Data\\New Fair Python for GRIB and ERA\\All GRIBS\\New_Chlorophyll_Precip_12H" 
output_folder_TSS = r"D:\\Shukra_sir\\WQI_Research\\Scripts and Data\\New Fair Python for GRIB and ERA\\All GRIBS\\New_TSS_Precip_12H"
output_folder_DOC = r"D:\\Shukra_sir\\WQI_Research\\Scripts and Data\\New Fair Python for GRIB and ERA\\All GRIBS\\New_DOC_Precip_12H"
output_folder_Pheophytin = r"D:\\Shukra_sir\\WQI_Research\\Scripts and Data\\New Fair Python for GRIB and ERA\\All GRIBS\\New_Pheophytin_Precip_12H"
...
def get_GRIB(folder, parameter):
    ...
    print(f"Downloading ERA5 Precipitation only data_{year} for {param}...")
    grib_file = os.path.join(output_folder, f'RevisedPrecipOnly_ERA5GRIB_{year}_{param}.grib')
    ...
    print(f"GRIB for precipitation only saved for {year} and for {param} as: {grib_file}")
